  ...
  return (
    <Form layout="vertical" onFinish={onFinish}>
      <Form.Item
        ...
        rules={[
          { required: true, message: "Please input your GitHub username!" },
        ]}
      >
        <Input readOnly />
      </Form.Item>
      ...
      <Form.Item
        ...
        name="description"
        rules={[
          { required: true, message: "Please describe your contribution!" },
        ]}
      >
        <TextArea rows={4} />
      </Form.Item>
      <Form.Item
        ...
        name="deliverables"
        rules={[{ required: true, message: "Please state your deliverables!" }]}
      >
        <TextArea rows={4} />
      </Form.Item>
      <Form.Item
        ...
        rules={[
          { required: true, message: "Please input the weights requested!" },
        ]}
      >
      ...
      <Form.Item
        ...
        rules={[
          { required: true, message: "Please input the minimum weights time!" },
        ]}
      >
        <Input type="number" min={1} />
      </Form.Item>
      ...
      >
        <Checkbox>
          I understand that I will receive a NOTICE OF ACCEPTANCE if this bid is
          accepted.
        </Checkbox>
      </Form.Item>
