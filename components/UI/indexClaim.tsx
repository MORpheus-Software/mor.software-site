        ...
        <div className="flex flex-col-reverse text-base text-gray-200 lg:grid lg:grid-cols-1 lg:space-x-4">
          <div className="col-span-3 flex h-full flex-col">
                  ...
                  <div className="flex w-full flex-col gap-8">
                    ...
                    <div className="sm:gap:0 flex flex-col gap-4 sm:flex-row">
                      <div className="flex min-w-[14rem]">
                        ...
                        <br /> To calculate your power factor please consult this Power Factor
                        Guide.
                      </div>
                    </div>
                    <div className="sm:gap:0 flex flex-col gap-4 sm:flex-row">
            ...
            <div className="mt-5 w-full">
              <StakeLock tokenAmount={tokenAmount} lockDuration={lockDuration} />
            </div>
          </div>
          {false && (
...
export default ClaimLockComponent;
